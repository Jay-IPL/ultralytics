# command: python noaa/train/inference.py --save_tracking_video --inference_folder '/home/jiemei/Documents/ultralytics/noaa/test_data' --confidence_threshold 0.167
...
if __name__ == '__main__':
    ...
    # Step-3: Save results.
    for i, r in enumerate(tqdm(results)): # each r is all detections from a 
        ...
        # Step-3.2: save tracking results into csv file
